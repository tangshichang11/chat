<script setup>
    ...
    const openSideBarHandle1 = () => {
        console.log("1111")
        console.log(sysStore.outerVisible)
        console.log("2222")
        sysStore.outerVisible = true
    }
</script>
        ...
        <div class="flex h-full w-full">
            ...
            <div class="flex flex-col w-full h-full border-0 rounded-3xl shadow-2xl shadow-indigo-900">
                ...
                <div class="flex m-5">
                    ...
                    <div class="flex items-center mr-4">
                        <el-button color="#f1f5f9" @click="openSideBarHandle1" circle :icon="House"></el-button>
                    </div>
                    <AutoInput></AutoInput>
                </div>
            </div>
