...
import SideBar4 from '../components/SideBar4.vue'
...
<template>
  ...
  <el-drawer
          ...
          style="height: auto"
  >
    <SideBar4 :size="size"></SideBar4>
  </el-drawer>
  <div
          v-else
          class="flex p-7 bg-white rounded-3xl"
          :style="'width: ' + size + 'px;'"
          v-show="sysStore.openSideBar2"
  >
    <SideBar4 :size="size"></SideBar4>
  </div>
</template>
