...
import AutoInput1 from './AutoInput1.vue'
...
<!--      <el-button @click="newChat1" :icon="Plus" style="width: 100%">小红书笔记生成器</el-button>-->
<!--      <el-button @click="newChat2" :icon="Plus" style="width: 100%">抖音短视频脚本</el-button>-->
<!--      <el-button @click="newChat3" :icon="Plus" style="width: 100%">PPT大纲生成器</el-button>-->
<!--      <el-button @click="newChat4" :icon="Plus" style="width: 100%">论文优化</el-button>-->
<!--      <el-button @click="newChat5" :icon="Plus" style="width: 100%">营销文案大师</el-button>-->
<!--      <el-button @click="newChat6" :icon="Plus" style="width: 100%">万能新闻稿</el-button>-->

        <AutoInput1></AutoInput1>
